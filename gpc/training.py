...
def train(  # noqa: PLR0915 this is a long function, don't limit to 50 lines
    ...
    def jit_simulate(
        ...
        Args:
            ...
            rngs: The random generator keys for each parallel environment.
        ...
        """
        # Simulate the episodes in parallel
    ...
    for i in range(num_iters):
        ...
        # Shard episode RNGs to ensure that simulations are parallelized across
        # devices
        rng, episode_rng = jax.random.split(rng)
        episode_rngs = jax.random.split(episode_rng, num_envs)
        episode_rngs = jax.device_put(episode_rngs, sharding)
