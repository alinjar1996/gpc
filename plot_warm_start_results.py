...
##
#
# Make bar charts showing performance with different warm-start strategies, as
# recorded by `examples/evaluate_warm_starts.py`
#
##
...
# Load saved results
with open("warm_start_eval_results.pkl", "rb") as f:
